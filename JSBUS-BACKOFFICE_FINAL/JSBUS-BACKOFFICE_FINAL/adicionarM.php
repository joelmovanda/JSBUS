					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Adicionar motorista</span>
							</h2>
						...
						?>	
							...
							<form id="form1" name="form1" method="get" action="adicionarMF.php">
					 
								<label>Nome </label><input type= "text" name="nome" value="" size="20"/><br>
								<label>Email </label><input type= "text" name="email" value="" size="20"/><br>
								<label>Senha </label><input type="text" name="senha" value="" size="20"/><br>
								<label>Cartão de Cidadão</label>  <input type= "text" name="cartaoCidadao" value="" size="20"/><br>
								<label>Data de Nascimento </label><input type= "date" name="dataNasc" value="" size="20"/><br><BR>
