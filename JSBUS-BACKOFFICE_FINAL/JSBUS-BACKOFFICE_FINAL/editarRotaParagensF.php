					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							...
							if(!isset($_SESSION['email'])or ($_SESSION["email"])!='admin@gmail.com'){
								...
								{	
									$id_rota = $_GET["rota"];
									$id_paragem = $_GET["paragem"];
									$ordemParagem = $_GET["ordemParagem"];
									$offset = $_GET["offset"];
									...
									// UPDATE rota_paragem SET ordemParagem=2, offset='00:00:00' WHERE id_rota=1 and id_paragem=1;
									$sql = "UPDATE rota_paragem SET ordemParagem='$ordemParagem', offset='$offset' WHERE id_rota='$id_rota' and id_paragem='$id_paragem'";
									...
									echo "<br>".'<a href="rotaParagens.php?id='.$id_rota."\">"."Voltar a Pagina Inicial"."</a>"."</br>";
								}
							?> 
