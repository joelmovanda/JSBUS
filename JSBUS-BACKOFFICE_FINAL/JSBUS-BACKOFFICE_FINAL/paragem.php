					...
					<div class="col-xl-15 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Gestão das paragens</span>
							</h2>
						<div class="bg-faded rounded p-5">	
							...
							{	
								...
								while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
									...
									echo "<td>".$row['id_paragem']."</td>";
									echo "<td>".$row['descricao_paragem']."</td>";
									echo "<td>".$row['latitude']."</td>";
									echo "<td>".$row['longitude']."</td>";

									echo "<td style=\"text-align:center; vertical-align:midle;\">".'<a href="apagarPR.php?id='.$row['id_paragem']."\">"."<img src=\"./img/trash.png\" style=\"width:20px;height:20px \">"."</a>"."</td>";
									echo "<td style=\"text-align:center; vertical-align:midle;\">".'<a href="editarParagem.php?id='.$row['id_paragem']."\">"."<img src=\"img/editing.png\" style=\"width:20px;height:20px\">"."</a>"."</td>";

									//echo "<td>".'<a href="apagarPR.php?id='.$row['id_paragem']."\">"."Apagar"."</a>"."</td>";
									//echo "<td>".'<a href="editarParagem.php?id='.$row['id_paragem']."\">"."Editar"."</a>"."</td>";
									echo "</tr>";
						...
						?>	
							...
							<a class="btn btn-primary btn-m" id="adicionar" href="adicionarPR.php">Adicionar paragem</a>
						</div><br>
						</div>
						</div>
					</div>
