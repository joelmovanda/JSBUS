					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Gestão dos Autocarros</span>
							</h2>
						<div class="bg-faded rounded p-5">	
							...
							{	
								...
								while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
									...
									echo "<td>".$row['dataReg']."</td>";
									
						
									echo "<td style=\"text-align:center; vertical-align:midle;\">".'<a href="apagarA.php?id='.$row['id_autocarro']."\">"."<img src=\"./img/trash.png\" style=\"width:20px;height:20px \">"."</a>"."</td>";
									echo "<td style=\"text-align:center; vertical-align:midle;\">".'<a href="editarAutocarro.php?id='.$row['id_autocarro']."\">"."<img src=\"img/editing.png\" style=\"width:20px;height:20px\">"."</a>"."</td>";
									...
									// old delete link without image
									// echo "<td>".'<a href="apagarA.php?id='.$row['id_autocarro']."\">"."Apagar"."</a>"."</td>";
									// echo "<td>".'<a href="editarAutocarro.php?id='.$row['id_autocarro']."\">"."Editar"."</a>"."</td>";
						...
						?>	
							...
							<a class="btn btn-primary btn-m" id="adicionar" href="adicionarA.php">Adicionar autocarro</a>
						</div><br>
						</div>
						</div>
					</div>
