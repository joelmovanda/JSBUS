						...
						<div class="cta-inner text-center rounded">
							...
							$sentido=$_GET["sentido"];
								...
								include 'basedados/basedados.h';
									...
									$sql = "INSERT INTO rota(descricao_rota, cor,sentido) VALUES('$descricao', 
									'$cor','$sentido')";
									...
									if (mysqli_affected_rows ($conn) == 1)
									{
										...
										echo "<br><a href='rota.php'>Voltar à Pagina Incial</a>";
									} 
								 
								else
								{	
									echo ('<font color="red">Falha ao Adicionar a rota!!!</font>'); 
									echo "<br><a href='rota.php'>Voltar ao ínicio</a>";
								}
							}			
						?>
