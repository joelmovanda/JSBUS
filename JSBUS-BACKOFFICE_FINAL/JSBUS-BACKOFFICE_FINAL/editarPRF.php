						...
						<div class="cta-inner text-center rounded">
							...
							if(!isset($_SESSION['email'])or ($_SESSION["email"])!='admin@gmail.com'){
								...
								{	
									...
									$sql = "UPDATE paragem SET descricao_paragem ='$descricao_paragem',latitude='$latitude',longitude='$longitude' WHERE id_paragem='$id_paragem'";
									...
									echo "<br><a href='paragem.php'>Voltar a Pagina Inicial </a>";
								}
							?> 
