					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Gestão dos horários</span>
							</h2>
							...
							$descricao_rota=$_GET["rota"];
							$descricao_horario=$_GET["horario"];
							$nome_motorista=$_GET["motorista"];
							$autocarro=$_GET["autocarro"];
							$tempo=$_GET["tempo"];
								...
								include 'basedados/basedados.h';
									...
									$sql = "INSERT INTO horario(id_rota, descricao_horario,id_motorista,id_autocarro,tempo) VALUES('$descricao_rota', 
									'$descricao_horario','$nome_motorista','$autocarro','$tempo')";
									
									$retval = mysqli_query( $conn, $sql );
									if (mysqli_affected_rows ($conn) == 1)
									{
										echo ('<font color="green">adicionado  com sucesso!!!</font>');
										echo "<br><a href='horario.php'>Voltar à Pagina Incial</a>";
									} 
								 
								else
								{	
									echo ('<font color="red">Falha ao Adicionar o horario!!!</font>'); 
									echo "<br><a href='horario.php'>Voltar ao ínicio</a>";
								}
							}			
						?>
