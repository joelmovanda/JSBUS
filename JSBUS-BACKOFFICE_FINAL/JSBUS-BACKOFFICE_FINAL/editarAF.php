					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							...
							if(!isset($_SESSION['email'])or ($_SESSION["email"])!='admin@gmail.com'){
								...
								{	
									$id_autocarro = $_GET["id_autocarro"];
									$modelo = $_GET["modelo"];
									...
									$sql = "UPDATE autocarro SET modelo ='$modelo',matricula='$matricula',numero='$numero',lotacao='$lotacao',dataReg='$dataReg' WHERE id_autocarro='$id_autocarro'";
									...
									echo "<br><a href='autocarro.php'>Voltar a Pagina Inicial </a>";
								}
							?> 
