						...
						<div class="cta-inner text-center rounded">
							...
							if(!isset($_SESSION['email'])or ($_SESSION["email"])!='admin@gmail.com'){
								...
								{	
									...
									$descricao_horario = $_GET["descricao_horario"];
									...
									$sql = "UPDATE horario SET descricao_horario ='$descricao_horario',id_motorista='$motorista',id_rota='$rota',id_autocarro='$autocarro',tempo='$tempo' WHERE id_horario='$id_horario'";
									...
									echo "<br><a href='horario.php'>Voltar a Pagina Inicial </a>";
								}
							?> 
