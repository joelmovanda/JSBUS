					...
					<div class="col-xl-9 mx-auto">
						...
						<div class="bg-faded rounded p-5">	
							...
							{	
								...
								echo "<table border='1' style='text-align:center;'><tr><th>Nome</th><th>Senha</th><th>Email</th><th>Cartao de cidadão</th><th>Data de nascimento</th><th>Alterar</th></tr>";
								...
								while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
									echo "<td>".$row['nome_admin']."</td>";
									echo "<td>".$row['senha']."</td>";
									echo "<td>".$row['email']."</td>";
									echo "<td>".$row['cartaoCidadao']."</td>";
									echo "<td>".$row['dataNasc']."</td>";
									echo "<td style=\"text-align:center; vertical-align:midle;\">".'<a href="dadosPessoais.php?nome='.$row['nome_admin']."\">"."<img src=\"img/editing.png\" style=\"width:20px;height:20px\">"."</a>"."</td>";

									//echo "<td>".'<a href="dadosPessoais.php?nome='.$row['nome_admin']."\">"."Alterar"."</a>"."</td>";
									echo "</tr>";
