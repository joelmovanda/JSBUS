						...
						<div class="cta-inner text-center rounded">
							...
							$dataNasc=$_GET["dataNasc"];
								...
								include 'basedados/basedados.h';
									...
									$sql = "INSERT INTO motorista(nome_motorista, email,senha,cartaoCidadao,dataNasc) VALUES('$nome', 
									'$email','$senha','$cartaoCidadao','$dataNasc')";
									
									$retval = mysqli_query( $conn, $sql );
									if (mysqli_affected_rows ($conn) == 1)
									{
										echo ('<font color="green">adicionado  com sucesso!!!</font>');
										echo "<br><a href='motorista.php'>Voltar à Pagina Incial</a>";
									} 
								 
								else
								{	
									echo ('<font color="red">Falha ao Adicionar o motorista!!!</font>'); 
									echo "<br><a href='motorista.php'>Voltar ao ínicio</a>";
								}
							}			
						?>
