					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Editar dados da rota</span>
							</h2>
							...
							if(!isset($_SESSION['email'])or ($_SESSION["email"])!='admin@gmail.com'){
								...
								?>		
									<form action="editarRF.php" method="GET">
									<input type="hidden" name="id_rota" value="<?php echo $row['id_rota'] ?>" size="10"/><br>
									<label>rota </label><input type="text" name="descricao_rota" value="<?php echo $row['descricao_rota'] ?>" size="20"/><br>
									<label>Cor </label><input type="text"name="cor" value="<?php echo $row['cor'] ?>" size="20"/><br>
									<label>Sentido </label><input type="text" name="sentido" value="<?php echo $row['sentido'] ?>" size="20"/><br>
