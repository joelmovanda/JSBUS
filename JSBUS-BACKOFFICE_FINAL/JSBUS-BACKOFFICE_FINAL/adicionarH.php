					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Adicionar horário</span>
							</h2>
						...
						?>	
							...
							<form id="form1" name="form1" method="get" action="adicionarHF.php">
					 
								
								<label>Horário </label><input type= "text" name="horario" value="" size="20"/><br>
								...
								<label>Hora de Partida </label><input type="time"  id="tempo" name="tempo"/><br><br>
