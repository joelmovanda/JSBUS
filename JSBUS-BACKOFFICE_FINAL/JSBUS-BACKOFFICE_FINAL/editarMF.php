						...
						<div class="cta-inner text-center rounded">
							...
							if(!isset($_SESSION['email'])or ($_SESSION["email"])!='admin@gmail.com'){
								...
								{	
									...
									$sql = "UPDATE motorista SET nome_motorista ='$nome',email='$email',senha='$senha',dataNasc='$dataNasc',cartaoCidadao='$cartaoCidadao' WHERE id_motorista='$id_motorista'";
									...
									echo "<br><a href='motorista.php'>Voltar a Pagina Inicial </a>";
								}
							?> 
