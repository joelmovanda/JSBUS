					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Adicionar rota</span>
							</h2>
						...
						?>	
							...
							<form id="form1" name="form1" method="get" action="adicionarRF.php">
					 
								<label>Descrição</label> <input type= "text" name="descricao" value="" /><br>
								<label>Cor </label><input type= "text" name="cor" value="" /><br>
								<label>Sentido</label> <input type="text" name="sentido" value="" /><br><br>
