					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Editar dados do horário</span>
							</h2>
						...
						?>	
									<form action="editarHF.php" method="GET">
									<input type="hidden" name="id_horario" value="<?php echo $row['id_horario']?>" size="10"/><br>
									<label>Horário </label><input type="text"name="descricao_horario" value="<?php echo $row['descricao_horario']?>" size="30"/><br>
									<label>Hora de Partida</label><input type="time" name="tempo" value="<?php echo $row['tempo']?>" size="10"/><br>

									<label>Motorista </label><select name="motorista" id="motorista">
								<?php 
								include 'basedados/basedados.h';
								...
								while($row = mysqli_fetch_array($retval)){
									?>
									<option value="<?php echo $row['id_motorista']?>" > <?php echo $row['nome_motorista']; ?> </option>
								<?php
								}
								?>
								</select><br>
								...
								<label>Autocarro</label><select name="autocarro" id="autocarro">
								<?php 
								include 'basedados/basedados.h';
								
								$sql = "SELECT * FROM autocarro ";
								...
								while($row = mysqli_fetch_array($retval)){
									?>
									<option value="<?php echo $row['id_autocarro']?>" > <?php echo $row['matricula']; ?> </option>
								<?php
								}
								?>
								...
								<div class="position bottom-10 end-10">
									<a class="btn btn-primary btn-m" id="voltar"href="horario.php">Voltar</a>
								</div> 
