				...
				<div class="row">
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							...
							$descricao_paragem=$_GET["descricao_paragem"];
							...
							$longitude=$_GET["longitude"];
								...
								include 'basedados/basedados.h';
									...
									$sql = "INSERT INTO paragem(descricao_paragem,latitude,longitude) VALUES('$descricao_paragem', 
									'$latitude','$longitude')";
									...
									if (mysqli_affected_rows ($conn) == 1)
									{
										...
										echo "<br><a href='paragem.php'>Voltar à Pagina Incial</a>";
									} 
								 
								else
								{	
									echo ('<font color="red">Falha ao Adicionar a paragem!!!</font>'); 
									echo "<br><a href='paragem.php'>Voltar ao ínicio</a>";
								}
							}			
						?>
