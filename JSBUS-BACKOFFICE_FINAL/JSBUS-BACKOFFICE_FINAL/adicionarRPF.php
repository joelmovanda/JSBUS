					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Adicionar paragens</span>
							</h2>
							...
							$offset=$_GET["offset"];
								...
								include 'basedados/basedados.h';
									...
									$sql = "INSERT INTO rota_paragem(ordemParagem,id_paragem,id_rota,offset) VALUES('$ordemParagem', 
									'$paragem','$rota','$offset')";
									...
									if (mysqli_affected_rows ($conn) == 1)
									{
										...
										echo "<br>".'<a href="rotaParagens.php?id='.$rota."\">"."Voltar a Pagina Inicial"."</a>"."</br>";
									} 
