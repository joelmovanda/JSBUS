					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Apagar Paragem da rota</span>
							</h2>
							...
							else
							{
								...
								$sql = "SELECT r.id_rota ,r.descricao_rota,r.cor,p.id_paragem ,p.latitude,p.longitude,p.descricao_paragem,rp.ordemParagem FROM rota_paragem rp  
								...
								while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
									...
									echo'<form action="apagarRotaParagensF.php" method="GET">';	
