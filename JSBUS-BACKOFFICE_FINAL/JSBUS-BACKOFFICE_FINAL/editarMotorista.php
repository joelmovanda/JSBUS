						...
						<div class="cta-inner text-center rounded">
							...
							if(!isset($_SESSION['email'])or ($_SESSION["email"])!='admin@gmail.com'){
							...
							}else
								{
									...
									$sql = "SELECT * FROM motorista WHERE id_motorista=$id_motorista";
								...
								?>			
									...
									<form action="editarMF.php" method="GET">
									<input type="hidden" name="id_motorista" value="<?php echo $row['id_motorista']?>" size="10"/><br>
									<label>Nome </label><input name="nome" type="text" value="<?php echo $row['nome_motorista']?>" size="30"/><br>
									<label>Email  </label><input type="text" name="email" value="<?php echo $row['email']?>" size="30"/><br>
									<label>Senha </label> <input name="senha" type="text"value="<?php echo $row['senha']?>" size="30"/><br>
									<label>Data de Nascimento</label><input name="dataNasc" type="date" value="<?php echo $row['dataNasc']?>" size="10"/><br>
									<label>Cartão de Cidadão </label><input name="cartaoCidadao" type="text" value="<?php echo $row['cartaoCidadao']?>" size="10"/><br>
									<input type="submit" value="Confirmar"/>
									</form>
									<div class="position bottom-10 end-10">
										<a class="btn btn-primary btn-m" id="voltar"href="motorista.php">Voltar</a>
									</div>		
