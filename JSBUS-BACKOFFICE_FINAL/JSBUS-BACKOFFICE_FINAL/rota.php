					...
					<div class="col-xl-15 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Gestão das rotas</span>
							</h2>
							...
							{	
								...
								while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
									...
									echo "<td>".'<a href="rotaParagens.php?id='.$row['id_rota']."\">".$row['descricao_rota']."</a>"."</td>";
									echo "<td>".$row['cor']."</td>";
									echo "<td>".$row['sentido']."</td>";

									echo "<td style=\"text-align:center; vertical-align:midle;\">".'<a href="apagarR.php?id='.$row['id_rota']."\">"."<img src=\"./img/trash.png\" style=\"width:20px;height:20px \">"."</a>"."</td>";
									echo "<td style=\"text-align:center; vertical-align:midle;\">".'<a href="editarRota.php?id='.$row['id_rota']."\">"."<img src=\"img/editing.png\" style=\"width:20px;height:20px\">"."</a>"."</td>";

									//echo "<td>".'<a href="apagarR.php?id='.$row['id_rota']."\">"."Apagar"."</a>"."</td>";
									//echo "<td>".'<a href="editarRota.php?id='.$row['id_rota']."\">"."Editar"."</a>"."</td>";
									echo "</tr>";
						...
						?>	
							...
							<a class="btn btn-primary btn-m" id="adicionar" href="adicionarR.php">Adicionar rota</a>
							</div><br>
							</div>
						</div>
