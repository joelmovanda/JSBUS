				...
				<div class="row">
					<div class="col-xl-9 mx-auto">
						...
						?>	
							...
							<form id="form1" name="form1" method="get" action="adicionarPRF.php">
					 
							
								
								<label>Descrição paragem </label> <input type= "text" name="descricao_paragem" value="" size="20"/><br>
								<label>Latitude</label> <input type= "text" name="latitude" value="" size="20"/><br>
								<label>Longitude</label> <input type="text" name="longitude" value="" size="20"/><br>
