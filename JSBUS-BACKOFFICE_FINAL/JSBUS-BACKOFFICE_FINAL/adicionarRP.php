					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Adicionar paragem na rota</span>
							</h2>
						...
						?>	
							...
							<form id="form1" name="form1" method="get" action="adicionarRPF.php">
					 <label>Ordem paragem  </label><input type= "text" name="ordemParagem" value="" size="20"/><br>
					 <label>Selecione a paragem </label><select name="paragem" id="paragem">
					 		<?php 
								...
								<label>Offset </label><input type="time" name="offset"  id="offset" value="" /><br>
								<input type="hidden" name="id_rota"  id="id_rota" value="<?php echo $rota ?>" /><br>
								<input type="submit" value="Adicionar"/>

							</form>
							<div class="position bottom-10 end-10">
								<a class="btn btn-primary btn-m" id="voltar"href="rotaParagens.php?id=<?php echo $rota;?>">Voltar</a>
							</div>
