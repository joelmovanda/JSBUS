						...
						<div class="cta-inner text-center rounded">
							...
							if(!isset($_SESSION['email'])or ($_SESSION["email"])!='admin@gmail.com'){
								...
								{	
									...
									$descricao_rota = $_GET["descricao_rota"];
									$cor = $_GET["cor"];
									...
									$sql = "UPDATE rota SET descricao_rota ='$descricao_rota',cor='$cor',sentido='$sentido' WHERE id_rota='$id_rota'";
									...
									echo "<br><a href='rota.php'>Voltar a Pagina Inicial </a>";
								}
							?> 
