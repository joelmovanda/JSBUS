					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Apagar horário</span>
							</h2>
						<div class="bg-faded rounded p-5">	
							...
							else
							{
								...
								$sql = "SELECT  m.nome_motorista, a.matricula, h.descricao_horario,h.id_horario,m.id_motorista,h.id_autocarro,r.descricao_rota,h.tempo FROM horario h INNER JOIN motorista m ON m.id_motorista=h.id_motorista
								INNER JOIN rota r ON r.id_rota= h.id_rota INNER JOIN autocarro a ON h.id_autocarro=a.id_autocarro WHERE h.id_horario='$id_horario'";
								...
								while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
									...
									echo'<form action="apagarHF.php" method="GET">';	
									echo'<input type="hidden" name="id_horario" value='.$row['id_horario'].' size="10"/><br>';
