						...
						<div class="cta-inner text-center rounded">
							...
							$dataReg=$_GET["dataReg"];
								...
								include 'basedados/basedados.h';
									...
									$sql = "INSERT INTO autocarro(modelo, matricula,numero,lotacao,dataReg) VALUES('$modelo', 
									'$matricula','$numero','$lotacao','$dataReg')";
									
									$retval = mysqli_query( $conn, $sql );
									if (mysqli_affected_rows ($conn) == 1)
									{
										echo ('<font color="green">adicionado  com sucesso!!!</font>');
										echo "<br><a href='autocarro.php'>Voltar à Pagina Incial</a>";
									} 
								 
								else
								{	
									echo ('<font color="red">Falha ao Adicionar o motorista!!!</font>'); 
									echo "<br><a href='autocarro.php'>Voltar ao ínicio</a>";
								}
							}			
						?>
