					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Apagar motorista</span>
							</h2>
							...
							else
							{
								...
								while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
									...
									echo'<form action="apagarMF.php" method="GET">';	
									echo'<input type="hidden" name="id_motorista" value='.$row['id_motorista'].' size="10"/><br>';
