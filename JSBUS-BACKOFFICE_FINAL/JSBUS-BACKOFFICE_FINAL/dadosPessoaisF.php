			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					...
					<li class="nav-item active px-lg-4">
						<a class="nav-link text-uppercase text-expanded" href="dadosPessoais.php">Perfil</a>
					</li>
					<li class="nav-item px-lg-4">
						<a class="nav-link text-uppercase text-expanded" href="visualizaDadosA.html">logout</a>
					</li>
					</ul>
				</div>
			</div>
				...
				if(!isset($_SESSION["email"]) or $_SESSION["email"]!="admin@gmail.com"){
					header("Location:pagLogin.html");
					...
					}else
								{
									...
									$senha = $_GET["senha"];
									$cartaoCidadao = $_GET["cartaoCidadao"];
									...
									$sql = "UPDATE administrador SET senha='$senha',cartaoCidadao='$cartaoCidadao',dataNasc='$dataNasc' WHERE nome_admin='$nome_admin'";
									...
									echo "<br><a href='visualizaDadosA.php'>Voltar </a>";
								}
			?>	
