...
<html lang="en">
	...
	<body>
		...
		<nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					...
					<li class="nav-item px-lg-4">
						<a class="nav-link text-uppercase text-expanded" href="motorista.php">Motorista</a>
					</li>
					<li class="nav-item px-lg-4">
		...
		<section class="page-section cta">
				...
				<div class="row">
					<div class="col-xl-9 mx-auto">
						...
						<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Editar Perfil </span>
						</h2>
							...
							$retval = mysqli_query( $conn, $sql );
								if(! $retval ){
									...
									while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
										echo'<form action="dadosPessoaisF.php" method="GET">';
										echo'<input type="hidden" name="nome_admin" value='.$row['nome_admin'].' size="10"/><br>';
										echo'<label>Senha</label> <input type="text" name="senha" value='.$row['senha'].' size="10"/><br>';
										echo'<label>Cartão de cidadão</label><input type="text" name="cartaoCidadao" value='.$row['cartaoCidadao'].' size="10"/><br>';
										echo'<label>Data de nascimento</label><input type="date"name="dataNasc" value='.$row['dataNasc'].' size="10"/><br>';
			...
			?>	
						 	<div class="position bottom-10 end-10">
								<a class="btn btn-primary btn-m" id="voltar"href="visualizaDadosA.php">Voltar</a>
							</div>
						</div>
					</div>
				</div>
