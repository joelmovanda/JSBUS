					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Editar dados da paragem</span>
							</h2>
							...
							if(!isset($_SESSION['email'])or ($_SESSION["email"])!='admin@gmail.com'){
								...
								?>			
									...
									<form action="editarPRF.php" method="GET">
									<input type="hidden" name="id_paragem" value="<?php echo $row['id_paragem']?>" size="10"/><br>
									<label>Paragem </label><input type="text" name="descricao_paragem" value="<?php echo $row['descricao_paragem']?>" size="30"/><br>
									<label>Latitude</label> <input type="text" name="latitude" value="<?php echo $row['latitude']?>" size="30"/><br>
									<label>Longitude</label><input type="text" name="longitude" value="<?php echo $row['longitude']?>" size="30"/><br>
